...
public class DeliverMessage extends ReduceStub {

  private final PactRecord outputRecord = new PactRecord();

  @Override
  public void reduce(Iterator<PactRecord> records, Collector<PactRecord> collector) throws Exception {
    PactInteger recipientVertex = records.next().getField(1, PactInteger.class);

    outputRecord.setField(0, recipientVertex);
