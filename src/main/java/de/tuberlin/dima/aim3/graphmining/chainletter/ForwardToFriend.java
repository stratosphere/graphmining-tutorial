...
public class ForwardToFriend extends MatchStub {

  private final Random random = new Random(Config.randomSeed());

  @Override
  public void match(PactRecord recipientState, PactRecord edge, Collector<PactRecord> collector) throws Exception {
